        ...
        <div className="md:w-1/2 p-8 lg:p-12 flex flex-col justify-center bg-[#ffffff] relative">
          <div className="w-full max-w-sm mx-auto">
            ...
            <div className="text-left mb-6">
              <h2 className="text-xl lg:text-2xl font-bold text-white tracking-tight">Welcome Back</h2>
              <p className="text-slate-400 text-xs mt-1">Sign in to manage your store's campaign rewards</p>
            </div>
            ...
            <p className="mt-6 text-center text-xs text-slate-400 font-medium">
              ...
              <Link to="/signup" className="text-brand-500 hover:text-brand-600 font-bold transition-colors duration-200">
                Sign Up
              </Link>
            </p>
          </div>
