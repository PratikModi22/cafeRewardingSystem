  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] right-[20%] w-[30rem] h-[30rem] rounded-full bg-brand-500/10 blur-[8rem]" />
        <div className="absolute bottom-[20%] left-[20%] w-[30rem] h-[30rem] rounded-full bg-[#1e293b]/20 blur-[8rem]" />
      </div>
      ...
      <div className="relative w-full max-w-md bg-[#0f172a]/80 backdrop-blur-md border border-[#1e293b] p-8 rounded-3xl shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white text-center">Create Merchant Account</h2>
          <p className="text-slate-400 text-sm mt-1 text-center">Set up your cafe and start rewarding customers</p>
        </div>
